...
public class Doctorprofile extends AppCompatActivity implements View.OnClickListener {
    ...
    private EditText fullnameEdit,usernameEdit,emailEdit,passwordEdit,contactnoEdit,BMAEdit,deptEdit;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        BMAEdit=(EditText)findViewById(R.id.BMAEdit);
        deptEdit=(EditText)findViewById(R.id.deptEdit);
        passwordEdit=(EditText)findViewById(R.id.passwordid);
    ...
    public void onClick(View view) {
        ...
        String bma_reg_no=BMAEdit.getText().toString();
        ...
        if(view.getId()==R.id.registerid){
            long rowId= (long) myDatabaseHelper.insertData_doc(fullname,username,email,password,gender,bma_reg_no,department,dateofbirth,bloodgroup,city,contactno);
            if(rowId==-1){
